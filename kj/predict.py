...
def load(asset):
    ...
    with graph.as_default():
        ...
        with sess.as_default():
            saver = tf.train.import_meta_graph('{}.meta'.format(module_path + "/save/" + str(asset) + "/" + str(asset)))
            saver.restore(sess, tf.train.latest_checkpoint(module_path+ "/save/" + str(asset)))
